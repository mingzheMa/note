import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,d as p}from"./app.002a81c8.js";const t={},e=p(`<h1 id="手写commonjs-node环境" tabindex="-1"><a class="header-anchor" href="#手写commonjs-node环境" aria-hidden="true">#</a> 手写CommonJS（node环境）</h1><p>CommonJS是解决js工程化问题，是代码层面实现的，我们先看下使用方法</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 导出模块</span>
