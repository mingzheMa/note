import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,d as e}from"./app.9ac9284b.js";const p="/assets/mount.41beeec2.png",t={},o=e(`<h1 id="vnode到dom-组件渲染" tabindex="-1"><a class="header-anchor" href="#vnode到dom-组件渲染" aria-hidden="true">#</a> vnode到dom（组件渲染）</h1><p>在vue3中组件是很重要的概念，整个应用都是由组件构成，组件是对一颗dom树的抽象，一个组件生成真实的dom有以下步骤</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>构建vnode =&gt; 渲染vnode =&gt; 生成dom
