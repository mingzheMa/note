import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,e as a,w as e,d as n,r as i,b as t}from"./app.9ac9284b.js";const l={},u=n('<h1 id="nexttick" tabindex="-1"><a class="header-anchor" href="#nexttick" aria-hidden="true">#</a> nexttick</h1><p><code>nextTick</code>是Vue的一个核心实现，在介绍之前，先简单介绍一下JS的运行机制。</p><h2 id="浏览器事件循环" tabindex="-1"><a class="header-anchor" href="#浏览器事件循环" aria-hidden="true">#</a> 浏览器事件循环</h2><p>首先我们需要了解js在浏览器执行机制，分为主栈（execution context stack）和任务队列（task queue）：</p><ul><li>主栈：优先执行，当栈里任务（task）为空时会将任务队列的任务推入栈</li><li>任务队列：分为宏任务（macro task）、微任务（micro task） <ul><li>宏任务：setInteval、setTimeout、postMessage、</li><li>微任务：Promise获取结果操作、MutationObsever（监听dom变化）</li></ul></li></ul><p>流程：</p><ol><li>执行主栈任务</li><li>将微任务入栈执行</li><li>将宏任务入栈执行</li><li>重复1-3步骤</li></ol><h2 id="vue-nexttick-实现" tabindex="-1"><a class="header-anchor" href="#vue-nexttick-实现" aria-hidden="true">#</a> Vue nexttick 实现</h2>',8),r=n(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/* @flow */</span>
