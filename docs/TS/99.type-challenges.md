...
/* _____________ 你的代码 _____________ */
type MyThen<T> = T extends { then: (onfulfilled: (arg: infer Type) => any) => any } ? Type : T
type MyAwaited<T> = T extends Promise<infer Type> ? MyAwaited<Type> : MyThen<T>;
